...
@Injectable()
export class ColorDeviceService {

  constructor(private _http: HttpClient) {
  }

  public datatables(value: ColorDevice, datatablesParameters: any) {
